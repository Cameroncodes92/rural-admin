...
This app requests the following Admin API scopes:

- write_products
- write_delivery_customizations

Update scopes in `shopify.app.toml` under `[access_scopes]`, then redeploy (`npm run deploy`) so Shopify updates the app's requested scopes.
